...
insert into post(cid, uid, gid, title, contents, tag, tdate, likes) values(1, 'so', NULL, '테스트게시물1', '테스트 게시물1을 불러오는데 성공했습니다. 축하합니다^0^', '#테스트1 #테스트2', '2020-01-06', 1);
...
insert into post(cid, uid, gid, title, contents, tag, tdate, likes) values(6, 'si', NULL, '테스트게시물6', '테스트 게시물6을 불러오는데 성공했습니다. 축하합니다^0^', '#테스트6 #테스트3', '2020-05-08', 1);
insert into post(cid, uid, gid, title, contents, tag, tdate, likes) values(7, 'si', NULL, '테스트게시물7', '테스트 게시물7을 불러오는데 성공했습니다. 축하합니다^0^', '#테스트7 #테스트3', '2020-05-08', 0);
insert into post(cid, uid, gid, title, contents, tag, tdate, likes) values(8, 'si', NULL, '테스트게시물8', '테스트 게시물8을 불러오는데 성공했습니다. 축하합니다^0^', '#테스트8', '2020-05-10', 1);
...
insert into groupinfo(gid, gname, uid, tag) values(1, '소현이네', 'so', '#테스트1');
insert into groupinfo(gid, gname, uid, tag) values(2, '시연이네', 'si', '#테스트2');
insert into groupinfo(gid, gname, uid, tag) values(3, '주영이네', 'joo', '#테스트3');

insert into guserinfo(gid, uid, name) values(1, 'si', '권시연');
insert into guserinfo(gid, uid, name) values(1, 'joo', '우주영');
insert into guserinfo(gid, uid, name) values(1, 'test', '테스트');

insert into guserinfo(gid, uid, name) values(2, 'so', '이소현');
insert into guserinfo(gid, uid, name) values(2, 'joo', '우주영');

insert into guserinfo(gid, uid, name) values(3, 'so', '이소현');
